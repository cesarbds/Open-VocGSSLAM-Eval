...
from  datasets.basedataset import GradSLAMDataset
...
class ReplicaSemanticDataset(GradSLAMDataset):
    ...
    def get_filepaths(self):
        color_paths = natsorted(glob.glob(f"{self.input_folder}/images/frame*.jpg"))
        depth_paths = natsorted(glob.glob(f"{self.input_folder}/depth_images/depth*.png"))
    ...
    def load_poses(self):
        poses = []
        print("Pose path:", self.pose_path)
