...
from datasets.replica import ReplicaSemanticDataset
from datasets.tum import TUMSemanticDataset
from datasets.scannet import ScannetSemanticDataset

def get_dataset(config_dict, dataset_name, basedir, sequence, **kwargs):
    if dataset_name.lower() in ["replica"]:
        return ReplicaSemanticDataset(config_dict, dataset_name, basedir, sequence, **kwargs)
    elif dataset_name.lower() in ["scannet"]:
        return ScannetSemanticDataset(config_dict, basedir, sequence, **kwargs)
    elif dataset_name.lower() in ["tum"]:
