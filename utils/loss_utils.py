...
def semantic_loss(S_hat, S):
    """
    S_hat: predicted semantic features [N, D]
    S: ground truth semantic features [N, D]
    M_D: dynamic mask [N] (1=dynamic, 0=static)
    """

    # L1 distance between semantic features
